...
const desktopModeProps = {
  ...
  "Home": {
    ...
    "TextBox9": {
      "custom": {
        "text": "Order from your favouraite app today !"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image16": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/about%20foodimg.jpeg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox79": {
      "custom": {
        "text": "“You must try these Pattties\""
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image48": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/non%20veg%20burger.jpeg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Input9": {
      "custom": {
        "value": "",
        "placeholder": "Do you have any note for me ?"
      },
      "callbacks": {}
    },
    "TextBox114": {
